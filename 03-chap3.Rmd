...
If you wish to use a short figure caption for the table of figures use `fig.scap="short name"`, this is what will appear in the TOF, then use `fig.cap="long caption title and description of data"` to include the longer caption you wish to appear under the figure. 

```{r delaysboxplot, warnings=FALSE, messages=FALSE, fig.scap="Mean Delays by Airline", fig.cap="Bar graph showing the mean flight departure delays by airline from Portland for 2014. Only one airline was successful in decreasing the delay time (HA).", fig.width=6}
